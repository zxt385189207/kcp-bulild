...
extern "C" {
	...
	KCPDLL void ikcp_setoutput(ikcpcb *kcp, int(*output)(const char *buf, int len,
	...
	KCPDLL int ikcp_send(ikcpcb *kcp, const char *buffer, int len);
	...
	KCPDLL int ikcp_input(ikcpcb *kcp, const char *data, long offset, long size);
